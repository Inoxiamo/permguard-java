...
public final class V1PDPServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<policydecisionpoint.AuthorizationCheckNew.AuthorizationCheckRequest,
      policydecisionpoint.AuthorizationCheckNew.AuthorizationCheckResponse> getAuthorizationCheckMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "AuthorizationCheck",
      requestType = policydecisionpoint.AuthorizationCheckNew.AuthorizationCheckRequest.class,
      responseType = policydecisionpoint.AuthorizationCheckNew.AuthorizationCheckResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<policydecisionpoint.AuthorizationCheckNew.AuthorizationCheckRequest,
      policydecisionpoint.AuthorizationCheckNew.AuthorizationCheckResponse> getAuthorizationCheckMethod() {
    io.grpc.MethodDescriptor<policydecisionpoint.AuthorizationCheckNew.AuthorizationCheckRequest, policydecisionpoint.AuthorizationCheckNew.AuthorizationCheckResponse> getAuthorizationCheckMethod;
      ...
      synchronized (V1PDPServiceGrpc.class) {
        if ((getAuthorizationCheckMethod = V1PDPServiceGrpc.getAuthorizationCheckMethod) == null) {
          V1PDPServiceGrpc.getAuthorizationCheckMethod = getAuthorizationCheckMethod =
              io.grpc.MethodDescriptor.<policydecisionpoint.AuthorizationCheckNew.AuthorizationCheckRequest, policydecisionpoint.AuthorizationCheckNew.AuthorizationCheckResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "AuthorizationCheck"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  policydecisionpoint.AuthorizationCheckNew.AuthorizationCheckRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  policydecisionpoint.AuthorizationCheckNew.AuthorizationCheckResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void authorizationCheck(policydecisionpoint.AuthorizationCheckNew.AuthorizationCheckRequest request,
        io.grpc.stub.StreamObserver<policydecisionpoint.AuthorizationCheckNew.AuthorizationCheckResponse> responseObserver) {
  ...
  public static final class V1PDPServiceStub
    ...
    /**
     */
    public void authorizationCheck(policydecisionpoint.AuthorizationCheckNew.AuthorizationCheckRequest request,
        io.grpc.stub.StreamObserver<policydecisionpoint.AuthorizationCheckNew.AuthorizationCheckResponse> responseObserver) {
  ...
  public static final class V1PDPServiceBlockingStub
    ...
    /**
     */
    public policydecisionpoint.AuthorizationCheckNew.AuthorizationCheckResponse authorizationCheck(policydecisionpoint.AuthorizationCheckNew.AuthorizationCheckRequest request) {
  ...
  public static final class V1PDPServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<policydecisionpoint.AuthorizationCheckNew.AuthorizationCheckResponse> authorizationCheck(
        policydecisionpoint.AuthorizationCheckNew.AuthorizationCheckRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_AUTHORIZATION_CHECK:
          serviceImpl.authorizationCheck((policydecisionpoint.AuthorizationCheckNew.AuthorizationCheckRequest) request,
              (io.grpc.stub.StreamObserver<policydecisionpoint.AuthorizationCheckNew.AuthorizationCheckResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              policydecisionpoint.AuthorizationCheckNew.AuthorizationCheckRequest,
              policydecisionpoint.AuthorizationCheckNew.AuthorizationCheckResponse>(
  ...
  private static abstract class V1PDPServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return policydecisionpoint.AuthorizationCheckNew.getDescriptor();
    }
